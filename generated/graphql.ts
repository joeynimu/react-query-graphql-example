...
export const GetPastLaunchesDocument = `
  ...
  launchesPast(limit: 10) {
    ...
    `;
export const useGetPastLaunchesQuery = <
      TData = GetPastLaunchesQuery,
      TError = unknown
    >(
      variables?: GetPastLaunchesQueryVariables, 
      options?: UseQueryOptions<GetPastLaunchesQuery, TError, TData>
    ) => 
    useQuery<GetPastLaunchesQuery, TError, TData>(
      ['getPastLaunches', variables],
      CustomFetcher<GetPastLaunchesQuery, GetPastLaunchesQueryVariables>(GetPastLaunchesDocument).bind(null, variables),
      options
    );